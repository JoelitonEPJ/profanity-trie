...
def memory_usage_benchmark_plot():
    x = []
    y = []
    ...
    with open(RESULTS_DIR/"insertion_perf.csv", "r") as csvfile:
        ...
        ax.bar(x, y, width=0.5, color="royalblue")
        ...
        plt.savefig(GRAPHS_DIR/"insert_all_memory_usage.png", dpi=100)
...
def phrase_searching_accuracy_plot():
    x = []
    y = []
